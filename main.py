...
def main():
    ...
    if args.finetune:
        ...
        # Load pretrained encoder and create classifier
        print(f"Loading pretrained encoder from {args.checkpoint}...")
        contrastive_model = LitContrastive.load_from_checkpoint(args.checkpoint)
        ...
        # Checkpoint callback for classification
        ...
        # Contrastive mode - train encoder
        ...
        # Checkpoint callback for contrastive learning
